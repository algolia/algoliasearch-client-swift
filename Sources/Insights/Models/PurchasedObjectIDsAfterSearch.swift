...
public struct PurchasedObjectIDsAfterSearch: Codable, JSONEncodable, Hashable {
    ...
    public init(eventName: String, eventType: ConversionEvent, eventSubtype: PurchaseEvent, index: String, objectIDs: [String], userToken: String, authenticatedUserToken: String? = nil, currency: String? = nil, objectData: [ObjectDataAfterSearch]? = nil, timestamp: Int64? = nil, value: Value? = nil) {
