...
public struct DestinationIndexName: Codable, JSONEncodable, Hashable {
  ...
  public init(
    indexName: String, recordType: RecordType? = nil, attributesToExclude: [String]? = nil
  ) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(attributesToExclude, forKey: .attributesToExclude)
  }
}
