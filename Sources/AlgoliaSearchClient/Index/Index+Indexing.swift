...
extension Index {
  ...
  /**
     ...
     */
  @discardableResult public func saveObject(
    ...
    let command = Command.Indexing.SaveObject(
      indexName: name, record: object, requestOptions: requestOptions)
  ...
  @discardableResult public func saveObject(
    ...
    autoGeneratingObjectID: Bool = false,
    requestOptions: RequestOptions? = nil
  ) throws -> WaitableWrapper<ObjectCreation> {
    if !autoGeneratingObjectID {
  ...
  /**
     ...
     - Returns: Launched asynchronousoperation
     */
  @discardableResult public func saveObjects(
    ...
    batch(
      objects.map { .add($0, autoGeneratingObjectID: autoGeneratingObjectID) },
      requestOptions: requestOptions, completion: completion)
  }
  ...
  @discardableResult public func saveObjects(
    ...
    autoGeneratingObjectID: Bool = false,
    requestOptions: RequestOptions? = nil
  ) throws -> WaitableWrapper<BatchesResponse> {
    try batch(
      objects.map { .add($0, autoGeneratingObjectID: autoGeneratingObjectID) },
  ...
  /**
     ...
     - Returns: Launched asynchronousoperation
     */
  @discardableResult public func getObject<T: Decodable>(
    ...
    let command = Command.Indexing.GetObject(
      indexName: name, objectID: objectID, attributesToRetrieve: attributesToRetrieve,
      requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronousoperation
     */
  @discardableResult public func getObjects<T: Decodable>(
    withIDs objectIDs: [ObjectID],
    attributesToRetrieve: [Attribute] = [],
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<ObjectsResponse<T>>
  ) -> Operation & TransportTask {
    let command = Command.MultipleIndex.GetObjects(
      indexName: name, objectIDs: objectIDs, attributesToRetreive: attributesToRetrieve,
      requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  /**
     ...
     */
  @discardableResult public func replaceObject(
    withID objectID: ObjectID,
    by object: some Encodable,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<ObjectRevision>
  ) -> Operation & TransportTask {
    let command = Command.Indexing.ReplaceObject(
      indexName: name, objectID: objectID, replacementObject: object, requestOptions: requestOptions
    )
    return execute(command, completion: completion)
  }
  ...
  @discardableResult public func replaceObject(
    ...
    by object: some Encodable,
    requestOptions: RequestOptions? = nil
  ) throws -> WaitableWrapper<ObjectRevision> {
    let command = Command.Indexing.ReplaceObject(
      indexName: name, objectID: objectID, replacementObject: object, requestOptions: requestOptions
    )
    return try execute(command)
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func replaceObjects(
    replacements: [(objectID: ObjectID, object: some Encodable)],
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultBatchesCallback
  ) -> Operation {
    batch(
      replacements.map { .update(objectID: $0.objectID, $0.object) },
      requestOptions: requestOptions, completion: completion)
  }
  ...
  @discardableResult public func replaceObjects(
    ...
    try batch(
      replacements.map { .update(objectID: $0.objectID, $0.object) }, requestOptions: requestOptions
    )
  }
  ...
  /**
     ...
     - Returns: Launched asynchronousoperation
     */
  @discardableResult public func deleteObject(
    withID objectID: ObjectID,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<ObjectDeletion>
  ) -> Operation & TransportTask {
    let command = Command.Indexing.DeleteObject(
      indexName: name, objectID: objectID, requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  @discardableResult public func deleteObject(
    withID objectID: ObjectID,
    requestOptions: RequestOptions? = nil
  ) throws -> WaitableWrapper<ObjectDeletion> {
    let command = Command.Indexing.DeleteObject(
      indexName: name, objectID: objectID, requestOptions: requestOptions)
    return try execute(command)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func deleteObjects(
    withIDs objectIDs: [ObjectID],
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultBatchesCallback
  ) -> Operation {
    batch(
      objectIDs.map { .delete(objectID: $0) }, requestOptions: requestOptions,
  ...
  @discardableResult public func deleteObjects(
    ...
    try batch(objectIDs.map { .delete(objectID: $0) }, requestOptions: requestOptions)
  }
  ...
  /**
     ...
     */
  @discardableResult public func deleteObjects(
    byQuery query: DeleteByQuery,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<IndexRevision>
  ) -> Operation & TransportTask {
    let command = Command.Indexing.DeleteByQuery(
  ...
  @discardableResult public func deleteObjects(
    byQuery query: DeleteByQuery,
    requestOptions: RequestOptions? = nil
  ) throws -> WaitableWrapper<IndexRevision> {
    let command = Command.Indexing.DeleteByQuery(
      indexName: name, query: query, requestOptions: requestOptions)
    return try execute(command)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func partialUpdateObject(
    withID objectID: ObjectID,
    ...
    let command = Command.Indexing.PartialUpdate(
      indexName: name, objectID: objectID, partialUpdate: partialUpdate,
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func partialUpdateObjects(
    updates: [(objectID: ObjectID, update: PartialUpdate)],
    createIfNotExists: Bool = true,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultBatchesCallback
  ) -> Operation {
    batch(
      updates.map {
        .partialUpdate(objectID: $0.objectID, $0.update, createIfNotExists: createIfNotExists)
      }, requestOptions: requestOptions, completion: completion)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func batch(
    _ batchOperations: [BatchOperation],
    requestOptions _: RequestOptions? = nil
  ) throws -> WaitableWrapper<BatchesResponse> {
    let responses = try batchOperations.chunked(into: configuration.batchSize).map {
      try internalBatch($0)
    }
  ...
  @discardableResult public func batch(
    _ batchOperations: [BatchOperation],
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<WaitableWrapper<BatchesResponse>>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func clearObjects(
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<IndexRevision>
  ) -> Operation & TransportTask {
  ...
  public func replaceAllObjects(
    ...
    let moveOperations: [BatchOperation] = objects.map {
      .add($0, autoGeneratingObjectID: autoGeneratingObjectID)
    }
    let sourceIndexName = name
    let destinationIndexName: IndexName = "\(name)_tmp_\(Int.random(in: 0 ... 100_000))"
    let destinationIndex = Index(
      name: destinationIndexName, transport: transport, operationLauncher: operationLauncher,
    ...
    copy([.settings, .rules, .synonyms], to: destinationIndexName) {
      extract($0) { copyTaskWrapper in
        destinationIndex.batch(moveOperations) {
          extract($0) { batchTaskWrapper in
            destinationIndex.move(to: sourceIndexName) {
              extract($0) { moveTaskWrapper in
  ...
  /**
     ...
     */
  @discardableResult public func replaceAllObjects(
    with objects: [some Encodable],
    autoGeneratingObjectID: Bool = false,
    requestOptions _: RequestOptions? = nil
  ) throws -> [IndexedTask] {
...
extension Index {
  @discardableResult func internalBatch(
    _ batchOperations: [BatchOperation],
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<BatchResponse>
  ) -> Operation & TransportTask {
    let command = Command.Index.Batch(
      indexName: name, batchOperations: batchOperations, requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
