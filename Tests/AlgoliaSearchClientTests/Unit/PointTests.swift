...
class PointTests: XCTestCase {
  ...
  func testStringDecoding() throws {
    try AssertDecode("22.2268517,84.84634989999999", expected: Point(latitude: 22.2268517, longitude: 84.84634989999999))
  }
  
  func testDictionaryDecoding() throws {
    try AssertDecode(["lat": 22.2268517, "lng": 84.84634989999999], expected: Point(latitude: 22.2268517, longitude: 84.84634989999999))
  }
