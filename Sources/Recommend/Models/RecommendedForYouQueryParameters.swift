...
@objcMembers public class RecommendedForYouQueryParameters: NSObject, Codable, JSONEncodable {
  ...
  public init(
    ...
    personalizationImpact: Int? = 100, userToken: String, getRankingInfo: Bool? = false,
