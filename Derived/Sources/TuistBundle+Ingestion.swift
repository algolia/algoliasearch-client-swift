...
/// Since Ingestion is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "AlgoliaSearchClient_Ingestion"
    ...
    fatalError("unable to find bundle named AlgoliaSearchClient_Ingestion")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class IngestionResources: NSObject {
