...
extension RecommendClient {
  /**
     ...
     */
  @discardableResult public func getRecommendations(
    options: [RecommendationsOptions],
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<SearchesResponse>
  ) -> Operation {
    let command = Command.Recommend.GetRecommendations(
  ...
  /**
     ...
     - returns: Launched asynchronous operation
     */
  @discardableResult public func getRelatedProducts(
    options: [RelatedProductsOptions],
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<SearchesResponse>
  ) -> Operation {
    getRecommendations(
      options: options.map(\.recommendationsOptions),
  ...
  /**
     ...
     - returns: Launched asynchronous operation
     */
  @discardableResult public func getFrequentlyBoughtTogether(
