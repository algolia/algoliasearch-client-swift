...
extension SearchClient {
  ...
  /**
     ...
     */
  @discardableResult public func listIndices(
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<IndicesListResponse>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func listIndexAPIKeys(
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<ListAPIKeysResponse>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func multipleQueries(
    ...
    let command = Command.MultipleIndex.Queries(
      queries: queries, strategy: strategy, requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  @discardableResult public func search(
    ...
    strategy: MultipleQueriesStrategy = .none,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<MultiSearchResponse>
  ) -> Operation {
    let command = Command.MultipleIndex.Queries(
      queries: queries, strategy: strategy, requestOptions: requestOptions)
    return execute(command, completion: completion)
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func multipleGetObjects(
    requests: [ObjectRequest],
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<ObjectsResponse<JSON>>
  ) -> Operation {
    let command = Command.MultipleIndex.GetObjects(
      requests: requests, requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func multipleBatchObjects(
    operations: [(IndexName, BatchOperation)],
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<WaitableWrapper<BatchesResponse>>
  ) -> Operation {
    let command = Command.MultipleIndex.BatchObjects(
      operations: operations, requestOptions: requestOptions)
    return execute(
      command, transform: { .init(batchesResponse: $0, client: self) }, completion: completion)
  }
