...
public struct RecommendedForYouQuery: Codable, JSONEncodable, Hashable {
    ...
    public init(indexName: String, threshold: Int? = nil, maxRecommendations: Int? = nil, model: RecommendedForYouModel, queryParameters: RecommendedForYouQueryParameters? = nil, fallbackParameters: RecommendedForYouQueryParameters? = nil) {
