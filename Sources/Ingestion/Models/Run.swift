...
public struct Run: Codable, JSONEncodable, Hashable {
    ...
    public init(runID: String, appID: String, taskID: String, status: RunStatus, progress: RunProgress? = nil, outcome: RunOutcome? = nil, failureThreshold: Int? = nil, reason: String? = nil, reasonCode: RunReasonCode? = nil, type: RunType, createdAt: String, startedAt: String? = nil, finishedAt: String? = nil) {
        self.runID = runID
        self.appID = appID
        self.taskID = taskID
        self.status = status
