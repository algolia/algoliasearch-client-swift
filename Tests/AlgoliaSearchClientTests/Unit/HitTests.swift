...
class HitTests: XCTestCase {
    ...
    do {
      ...
      case .dictionary(let dict):
        let expectedKeys: Set<String> = [
          "name", "cuisine", "contact", "description", "is_open", "_geoloc",
        ]
  ...
  func testDecodingGeolocPointList() throws {
    ...
    XCTAssertEqual(
      hit.geolocation,
      .list([
        .init(latitude: 22.2268517, longitude: 84.8463498),
        .init(latitude: 48.855651, longitude: 2.2964417),
      ]))
  }
}
