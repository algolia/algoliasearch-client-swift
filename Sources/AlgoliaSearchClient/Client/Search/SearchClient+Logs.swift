...
extension SearchClient {
  ...
  /**
     ...
     */
  @discardableResult public func getLogs(
    offset: Int? = nil,
    length: Int? = nil,
    type: LogType = .all,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<LogsResponse>
  ) -> Operation {
    let command = Command.Advanced.GetLogs(
      indexName: nil, offset: offset, length: length, logType: type, requestOptions: requestOptions)
