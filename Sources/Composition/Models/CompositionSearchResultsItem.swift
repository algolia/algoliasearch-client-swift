...
public struct CompositionSearchResultsItem<T: Codable>: Codable, JSONEncodable {
    ...
    public init(
        ...
        query: String,
        params: String,
        compositions: [String: CompositionResultsCompositionInfoResponse]
    ) {
...
extension CompositionSearchResultsItem: Equatable where T: Equatable {
    public static func ==(lhs: CompositionSearchResultsItem<T>, rhs: CompositionSearchResultsItem<T>) -> Bool {
...
extension CompositionSearchResultsItem: Hashable where T: Hashable {
