...
public struct TopSearchWithAnalytics: Codable, JSONEncodable, Hashable {
  ...
  public init(
    search: String, count: Int, clickThroughRate: Double, averageClickPosition: Int,
    conversionRate: Double, trackedSearchCount: Int, clickCount: Int, conversionCount: Int,
    nbHits: Int
  ) {
    self.search = search
    self.count = count
