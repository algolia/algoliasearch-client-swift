...
extension InsightsClient {
  ...
  /**
     ...
     */
  @discardableResult public func sendEvent(
    _ event: InsightsEvent, requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<Empty>
  ) -> Operation {
    sendEvents([event], requestOptions: requestOptions, completion: completion)
  }
  ...
  @discardableResult public func sendEvent(
    ...
    try sendEvents([event], requestOptions: requestOptions)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func sendEvents(
    _ events: [InsightsEvent], requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<Empty>
  ) -> Operation {
