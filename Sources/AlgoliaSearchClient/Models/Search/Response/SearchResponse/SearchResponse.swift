...
public struct SearchResponse {
  ...
  public var disjunctiveFacets: [Attribute: [Facet]]? {
    get {
      disjunctiveFacetsStorage?.storage
    }
  ...
  public var hierarchicalFacets: [Attribute: [Facet]]? {
    get {
      hierarchicalFacetsStorage?.storage
    }
...
extension SearchResponse {
  public func extractHits<T: Decodable>() throws -> [T] {
  ...
  public func getPositionOfObject(withID objectID: ObjectID) -> Int? {
    hits.firstIndex { $0.objectID == objectID }
  }
}
