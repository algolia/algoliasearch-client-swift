...
public enum SourceInput: Codable, JSONEncodable, Hashable {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .sourceBigCommerce(let value):
      try container.encode(value)
    case .sourceBigQuery(let value):
      try container.encode(value)
    case .sourceCSV(let value):
      try container.encode(value)
    case .sourceCommercetools(let value):
      try container.encode(value)
    case .sourceDocker(let value):
      try container.encode(value)
    ...
    if let value = try? container.decode(SourceBigCommerce.self) {
      ...
      throw DecodingError.typeMismatch(
        ...
        .init(
          ...
          debugDescription: "Unable to decode instance of SourceInput"))
    }
  }
}
