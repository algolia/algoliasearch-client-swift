...
@objcMembers public class SearchForFacets: NSObject, Codable, JSONEncodable {
  ...
  public init(
    params: String? = "", query: String? = "", similarQuery: String? = "", filters: String? = "",
    ...
    facetQuery: String? = "", type: SearchTypeFacet
  ) {
    self.params = params
    self.query = query
