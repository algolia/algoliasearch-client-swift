...
public struct BaseTrendingItemsQuery: Codable, JSONEncodable, Hashable {
    ...
    public init(facetName: String? = nil, facetValue: String? = nil, model: TrendingItemsModel? = nil, queryParameters: SearchParamsObject? = nil, fallbackParameters: SearchParamsObject? = nil) {
