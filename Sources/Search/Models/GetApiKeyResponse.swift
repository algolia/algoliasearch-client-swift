...
public struct GetApiKeyResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(value: String? = nil, createdAt: Int64, acl: [Acl], description: String? = nil, indexes: [String]? = nil, maxHitsPerQuery: Int? = nil, maxQueriesPerIPPerHour: Int? = nil, queryParameters: String? = nil, referers: [String]? = nil, validity: Int? = nil) {
        self.value = value
