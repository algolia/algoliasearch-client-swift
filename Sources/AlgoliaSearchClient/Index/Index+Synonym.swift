...
extension Index {
  ...
  /**
     ...
     */
  @discardableResult public func saveSynonym(
    _ synonym: Synonym,
    forwardToReplicas: Bool? = nil,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<SynonymRevision>
  ) -> Operation {
    let command = Command.Synonym.Save(
      indexName: name, synonym: synonym, forwardToReplicas: forwardToReplicas,
  ...
  @discardableResult public func saveSynonym(
    ...
    forwardToReplicas: Bool? = nil,
    requestOptions: RequestOptions? = nil
  ) throws -> WaitableWrapper<SynonymRevision> {
    let command = Command.Synonym.Save(
      indexName: name, synonym: synonym, forwardToReplicas: forwardToReplicas,
      requestOptions: requestOptions)
  ...
  @available(
    *, deprecated,
    renamed: "saveSynonyms(_:forwardToReplicas:clearExistingSynonyms:requestOptions:completion:)"
  )
  @discardableResult public func saveSynonyms(
    _ synonyms: [Synonym],
    forwardToReplicas: Bool? = nil,
    replaceExistingSynonyms: Bool?,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<IndexRevision>
  ) -> Operation {
    let command = Command.Synonym.SaveList(
      indexName: name, synonyms: synonyms, forwardToReplicas: forwardToReplicas,
      clearExistingSynonyms: replaceExistingSynonyms, requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  @available(
    *, deprecated,
    renamed: "saveSynonyms(_:forwardToReplicas:clearExistingSynonyms:requestOptions:)"
  )
  @discardableResult public func saveSynonyms(
    _ synonyms: [Synonym],
    forwardToReplicas: Bool? = nil,
  ...
  @discardableResult public func saveSynonyms(
    ...
    let command = Command.Synonym.SaveList(
      indexName: name, synonyms: synonyms, forwardToReplicas: forwardToReplicas,
      clearExistingSynonyms: clearExistingSynonyms, requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func getSynonym(
    withID objectID: ObjectID,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<Synonym>
  ) -> Operation {
    let command = Command.Synonym.Get(
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func deleteSynonym(
    withID objectID: ObjectID,
    forwardToReplicas: Bool? = nil,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<IndexDeletion>
  ) -> Operation {
    let command = Command.Synonym.Delete(
      indexName: name, objectID: objectID, forwardToReplicas: forwardToReplicas,
      requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  @discardableResult public func deleteSynonym(
    ...
    forwardToReplicas: Bool? = nil,
    requestOptions: RequestOptions? = nil
  ) throws -> WaitableWrapper<IndexDeletion> {
    let command = Command.Synonym.Delete(
      indexName: name, objectID: objectID, forwardToReplicas: forwardToReplicas,
      requestOptions: requestOptions)
    return try execute(command)
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func searchSynonyms(
    _ query: SynonymQuery,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<SynonymSearchResponse>
  ) -> Operation {
    let command = Command.Synonym.Search(
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func clearSynonyms(
    forwardToReplicas: Bool? = nil,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<IndexRevision>
  ) -> Operation {
    let command = Command.Synonym.Clear(
      indexName: name, forwardToReplicas: forwardToReplicas, requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func replaceAllSynonyms(
    ...
    saveSynonyms(
      synonyms, forwardToReplicas: forwardToReplicas, clearExistingSynonyms: true,
