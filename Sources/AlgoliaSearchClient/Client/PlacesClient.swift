...
extension PlacesClient {
  ...
  @discardableResult public func search(
    query: PlacesQuery, requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<MultiLanguageResponse>
  ) -> Operation {
  ...
  /**
     ...
     */
  @discardableResult public func search(
    query: PlacesQuery, language: Language, requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<SingleLanguageResponse>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func getObject(
    withID objectID: ObjectID, requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<Hit<MultiLanguagePlace>>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func reverseGeocoding(
    geolocation: Point, hitsPerPage: Int? = nil, language: Language,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<SingleLanguageResponse>
  ) -> Operation {
    let command = Command.Places.ReverseGeocoding(
      geolocation: geolocation, language: language, hitsPerPage: hitsPerPage,
  ...
  /**
     ...
     */
  @discardableResult public func reverseGeocoding(
    geolocation: Point, hitsPerPage: Int? = nil, requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<MultiLanguageResponse>
  ) -> Operation {
    let command = Command.Places.ReverseGeocoding(
      geolocation: geolocation, language: nil, hitsPerPage: hitsPerPage,
      requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
