...
/// deserialization.
public struct SearchResponsePartial<T: Codable>: Codable, JSONEncodable {
    ...
    public init(from dictionary: [String: AnyCodable]) throws {
        ...
        self.hits = dictionary["hits"]?.value as? [T]
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.hits = try container.decodeIfPresent([T].self, forKey: .hits)
...
extension SearchResponsePartial: Equatable where T: Equatable {
    public static func ==(lhs: SearchResponsePartial<T>, rhs: SearchResponsePartial<T>) -> Bool {
...
extension SearchResponsePartial: Hashable where T: Hashable {
