...
extension SearchClient {
  ...
  /**
     ...
     */
  @discardableResult public func addAPIKey(
    with parameters: APIKeyParameters,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<APIKeyCreation>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func updateAPIKey(
    _ apiKey: APIKey,
    with parameters: APIKeyParameters,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<APIKeyRevision>
  ) -> Operation {
    let command = Command.APIKey.Update(
      apiKey: apiKey, parameters: parameters, requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func deleteAPIKey(
    _ apiKey: APIKey,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<APIKeyDeletion>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func restoreAPIKey(
    _ apiKey: APIKey,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<APIKeyCreation>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func listAPIKeys(
    requestOptions: RequestOptions? = nil,
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func getAPIKey(
    _ apiKey: APIKey,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<APIKeyResponse>
  ) -> Operation {
