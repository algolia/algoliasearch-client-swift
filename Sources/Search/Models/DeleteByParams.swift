...
public struct DeleteByParams: Codable, JSONEncodable, Hashable {
    ...
    public init(facetFilters: FacetFilters? = nil, filters: String? = nil, numericFilters: NumericFilters? = nil, tagFilters: TagFilters? = nil, aroundLatLng: String? = nil, aroundRadius: AroundRadius? = nil, insideBoundingBox: [[Double]]? = nil, insidePolygon: [[Double]]? = nil) {
