...
extension Index {
  ...
  /**
     ...
     */
  @discardableResult public func saveRule(
    _ rule: Rule,
    forwardToReplicas: Bool? = nil,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<IndexRevision>
  ) -> Operation {
    let command = Command.Rule.Save(
      indexName: name, rule: rule, forwardToReplicas: forwardToReplicas,
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func saveRules(
    _ rules: [Rule],
    forwardToReplicas: Bool? = nil,
    ...
    let command = Command.Rule.SaveList(
      indexName: name, rules: rules, forwardToReplicas: forwardToReplicas,
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func getRule(
    withID objectID: ObjectID,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<Rule>
  ) -> Operation {
    let command = Command.Rule.Get(
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func deleteRule(
    withID objectID: ObjectID,
    forwardToReplicas: Bool? = nil,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<IndexRevision>
  ) -> Operation {
    let command = Command.Rule.Delete(
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func searchRules(
    _ query: RuleQuery,
    requestOptions: RequestOptions? = nil,
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func clearRules(
    forwardToReplicas: Bool? = nil,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<IndexRevision>
  ) -> Operation {
    let command = Command.Rule.Clear(
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func replaceAllRules(
    with rules: [Rule],
    forwardToReplicas: Bool? = nil,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<IndexRevision>
    ...
    let command = Command.Rule.SaveList(
      indexName: name, rules: rules, forwardToReplicas: forwardToReplicas, clearExistingRules: true,
      requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
