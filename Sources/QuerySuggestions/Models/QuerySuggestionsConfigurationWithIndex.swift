...
public struct QuerySuggestionsConfigurationWithIndex: Codable, JSONEncodable, Hashable {
    ...
    public init(indexName: String, sourceIndices: [SourceIndex], languages: Languages? = nil, exclude: [String]? = nil, enablePersonalization: Bool? = nil, allowSpecialCharacters: Bool? = nil) {
