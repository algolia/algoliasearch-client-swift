...
public struct APIKeyParameters {
  ...
  public var validity: TimeInterval? = nil
  ...
  /**
   ...
   querying the index.
   */
  public var maxHitsPerQuery: Int? = nil
  ...
  /**
   ...
   querying the index.
   */
  public var maxQueriesPerIPPerHour: Int? = nil
   ...
   */
  public var indices: [IndexName]? = nil
   ...
   */
  public var referers: [String]? = nil
