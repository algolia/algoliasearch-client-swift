...
/// Since Insights is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "AlgoliaSearchClient_Insights"
    ...
    fatalError("unable to find bundle named AlgoliaSearchClient_Insights")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class InsightsResources: NSObject {
