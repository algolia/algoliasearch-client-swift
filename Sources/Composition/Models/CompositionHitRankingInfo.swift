...
public struct CompositionHitRankingInfo: Codable, JSONEncodable {
    ...
    public init(
        ...
        composed: [String: CompositionCompositionIdRankingInfo]? = nil
    ) {
...
extension CompositionHitRankingInfo: Equatable {
    public static func ==(lhs: CompositionHitRankingInfo, rhs: CompositionHitRankingInfo) -> Bool {
...
extension CompositionHitRankingInfo: Hashable {
