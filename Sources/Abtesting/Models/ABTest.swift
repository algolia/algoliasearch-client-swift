...
public struct ABTest: Codable, JSONEncodable, Hashable {
  ...
  public init(
    abTestID: Int, clickSignificance: Double, conversionSignificance: Double,
    addToCartSignificance: Double, purchaseSignificance: Double,
    revenueSignificance: [String: Double], updatedAt: String, createdAt: String, endAt: String,
    name: String, status: String, variants: [Variant]
  ) {
