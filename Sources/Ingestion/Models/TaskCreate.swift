...
public struct TaskCreate: Codable, JSONEncodable, Hashable {
    ...
    public init(sourceID: String, destinationID: String, trigger: TaskCreateTrigger, action: ActionType, enabled: Bool? = nil, failureThreshold: Int? = nil, input: TaskInput? = nil) {
