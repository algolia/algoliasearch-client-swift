...
public struct SourceIndex: Codable, JSONEncodable, Hashable {
    static let minHitsRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    static let minLettersRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    ...
    public init(indexName: String, replicas: Bool? = nil, analyticsTags: [String]? = nil, facets: [Facet]? = nil, minHits: Int? = nil, minLetters: Int? = nil, generate: [[String]]? = nil, external: [String]? = nil) {
