...
@objcMembers public class GetClickThroughRateResponse: NSObject, Codable, JSONEncodable {
  ...
  public init(
    rate: Double, clickCount: Int, trackedSearchCount: Int, dates: [ClickThroughRateEvent]
  ) {
    self.rate = rate
