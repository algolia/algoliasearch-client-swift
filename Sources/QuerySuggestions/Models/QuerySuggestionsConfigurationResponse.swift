...
public struct QuerySuggestionsConfigurationResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(appId: String? = nil, sourceIndicesAPIKey: String? = nil, suggestionsIndicesAPIKey: String? = nil, externalIndicesAPIKey: String? = nil, indexName: String, sourceIndices: [SourceIndex], languages: Languages? = nil, exclude: [String]? = nil, enablePersonalization: Bool? = nil, allowSpecialCharacters: Bool? = nil) {
        self.appId = appId
