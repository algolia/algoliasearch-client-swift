...
public struct CompositionSearchForFacetValuesParams: Codable, JSONEncodable {
    /// Search query.
...
extension CompositionSearchForFacetValuesParams: Equatable {
    public static func ==(
        lhs: CompositionSearchForFacetValuesParams,
        rhs: CompositionSearchForFacetValuesParams
    ) -> Bool {
        lhs.query == rhs.query &&
...
extension CompositionSearchForFacetValuesParams: Hashable {
