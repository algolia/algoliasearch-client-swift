...
/// Since Recommend is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "AlgoliaSearchClient_Recommend"
    ...
    fatalError("unable to find bundle named AlgoliaSearchClient_Recommend")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class RecommendResources: NSObject {
