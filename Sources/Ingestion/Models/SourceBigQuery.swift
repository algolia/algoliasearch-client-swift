...
public struct SourceBigQuery: Codable, JSONEncodable, Hashable {
    ...
    public init(projectID: String, datasetID: String, dataType: BigQueryDataType? = nil, table: String? = nil, tablePrefix: String? = nil, customSQLRequest: String? = nil, uniqueIDColumn: String? = nil) {
