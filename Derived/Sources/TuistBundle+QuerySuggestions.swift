...
/// Since QuerySuggestions is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "AlgoliaSearchClient_QuerySuggestions"
    ...
    fatalError("unable to find bundle named AlgoliaSearchClient_QuerySuggestions")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class QuerySuggestionsResources: NSObject {
