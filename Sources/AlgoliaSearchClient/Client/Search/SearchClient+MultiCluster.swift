...
extension SearchClient {
  ...
  /**
     ...
     */
  @discardableResult public func listClusters(
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<ClustersListResponse>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func listUsers(
    page: Int? = nil,
    hitsPerPage: Int? = nil,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<UserIDListResponse>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func assignUser(
    withID userID: UserID,
    toClusterWithName clusterName: ClusterName,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<Creation>
  ) -> Operation {
    let command = Command.MultiCluster.User.Assign(
      userID: userID, clusterName: clusterName, requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func assignUsers(
    withIDs userIDs: [UserID],
    toClusterWithName clusterName: ClusterName,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<Creation>
  ) -> Operation {
    let command = Command.MultiCluster.User.BatchAssign(
      userIDs: userIDs, clusterName: clusterName, requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func getUser(
    withID userID: UserID,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<UserIDResponse>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func getTopUser(
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<TopUserIDResponse>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func removeUser(
    withID userID: UserID,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<Deletion>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func searchUser(
    with query: UserIDQuery,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<UserIDSearchResponse>
  ) -> Operation {
    let command = Command.MultiCluster.User.Search(
      userIDQuery: query, requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func hasPendingMappings(
    retrieveMappings: Bool = false,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<HasPendingMappingResponse>
  ) -> Operation {
    let command = Command.MultiCluster.HasPendingMapping(
      retrieveMapping: retrieveMappings, requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
  ...
  @discardableResult public func hasPendingMappings(
    retrieveMappings: Bool = false,
    requestOptions: RequestOptions? = nil
  ) throws -> HasPendingMappingResponse {
    let command = Command.MultiCluster.HasPendingMapping(
      retrieveMapping: retrieveMappings, requestOptions: requestOptions)
    return try execute(command)
  }
