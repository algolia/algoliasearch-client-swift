...
public typealias ResultTaskCallback<T: IndexTask & Codable> = (Result<WaitableWrapper<T>, Error>) ->
  Void
public typealias ResultAppTaskCallback<T: AppTask & Codable> = (Result<WaitableWrapper<T>, Error>)
  -> Void
