...
public struct PersonalizationClient: Credentials {
  ...
  public init(appID: ApplicationID, apiKey: APIKey, region: Region? = nil) {
    let configuration = PersonalizationConfiguration(
      applicationID: appID, apiKey: apiKey, region: region)
...
extension PersonalizationClient {
  ...
  /**
     ...
     */
  @discardableResult public func setPersonalizationStrategy(
    _ personalizationStrategy: PersonalizationStrategy,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<SetStrategyResponse>
  ) -> Operation {
    let command = Command.Personalization.Set(
      strategy: personalizationStrategy, requestOptions: requestOptions)
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func getPersonalizationStrategy(
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<PersonalizationStrategy>
  ) -> Operation {
