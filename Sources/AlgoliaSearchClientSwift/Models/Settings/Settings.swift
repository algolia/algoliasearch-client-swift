...
public struct Settings: Codable {
   ...
   */
  public var searchableAttributes: [SearchableAttribute]? = nil
   ...
   */
  public var attributesForFaceting: [AttributeForFaceting]? = nil
   ...
   */
  public var unretrievableAttributes: [Attribute]? = nil
   ...
   */
  public var attributesToRetrieve: [Attribute]? = nil
  ...
  public var ranking: [RankingCriterion]? = nil
  /**
  ...
  public var customRanking: [CustomRankingCriterion]? = nil
  /**
   ...
   */
  public var sortFacetsBy: SortFacetsBy? = nil
   ...
   */
  public var attributesToHighlight: [Attribute]? = nil
   ...
   */
  public var attributesToSnippet: [Snippet]? = nil
   ...
   */
  public var highlightPreTag: String? = nil
   ...
   */
  public var highlightPostTag: String? = nil
   ...
   */
  public var snippetEllipsisText: String? = nil
   ...
   */
  public var restrictHighlightAndSnippetArrays: Bool? = nil
   ...
   */
  public var hitsPerPage: Int? = nil
   ...
   */
  public var paginationLimitedTo: Int? = nil
   ...
   */
  public var minWordSizeFor1Typo: Int? = nil
   ...
   */
  public var minWordSizeFor2Typos: Int? = nil
   ...
   */
  public var typoTolerance: TypoTolerance? = nil
   ...
   */
  public var allowTyposOnNumericTokens: Bool? = nil
   ...
   */
  public var disableTypoToleranceOnAttributes: [Attribute]? = nil
   ...
   */
  public var disableTypoToleranceOnWords: [String]? = nil
   ...
   */
  public var separatorsToIndex: String? = nil
   ...
   */
  public var ignorePlurals: IgnorePlurals? = nil
   ...
   */
  public var removeStopWords: RemoveStopWords? = nil
   ...
   */
  public var camelCaseAttributes: [Attribute]? = nil
   ...
   */
  public var decompoundedAttributes: DecompoundedAttributes? = nil
   ...
   */
  public var keepDiacriticsOnCharacters: String? = nil
   ...
   */
  public var queryLanguages: [Language]? = nil
   ...
   */
  public var enableRules: Bool? = nil
   ...
   */
  public var queryType: QueryType? = nil
   ...
   */
  public var removeWordsIfNoResults: RemoveWordIfNoResults? = nil
   ...
   */
  public var advancedSyntax: Bool? = nil
  
  /**
   - [Documentation](https://www.algolia.com/doc/api-reference/api-parameters//?language=swift)
   */
  public var advancedSyntaxFeatures: [AdvancedSyntaxFeatures]? = nil
   ...
   */
  public var optionalWords: [String]? = nil
   ...
   */
  public var disablePrefixOnAttributes: [Attribute]? = nil
   ...
   */
  public var disableExactOnAttributes: [Attribute]? = nil
   ...
   */
  public var exactOnSingleWordQuery: ExactOnSingleWordQuery? = nil
   ...
   */
  public var alternativesAsExact: [AlternativesAsExact]? = nil
   ...
   */
  public var numericAttributesForFiltering: [NumericAttributeFilter]? = nil
   ...
   */
  public var allowCompressionOfIntegerArray: Bool? = nil
   ...
   */
  public var attributeForDistinct: Attribute? = nil
   ...
   */
  public var distinct: Distinct? = nil
  ...
  /**
   ...
   - [Documentation](https://www.algolia.com/doc/api-reference/api-parameters//?language=swift)
   */
  public var replaceSynonymsInHighlight: Bool? = nil
   ...
   */
  public var minProximity: Int? = nil
   ...
   */
  public var responseFields: [ResponseField]? = nil
   ...
   */
  public var maxFacetHits: Int? = nil
  /**
   Settings version.
   */
