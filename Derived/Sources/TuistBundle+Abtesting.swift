...
/// Since Abtesting is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "AlgoliaSearchClient_Abtesting"
    ...
    fatalError("unable to find bundle named AlgoliaSearchClient_Abtesting")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class AbtestingResources: NSObject {
