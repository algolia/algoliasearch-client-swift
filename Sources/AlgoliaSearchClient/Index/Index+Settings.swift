...
extension Index {
  ...
  /**
     ...
     */
  @discardableResult public func getSettings(
  ...
  /**
     ...
     */
  public func getSettings(requestOptions: RequestOptions? = nil) throws -> Settings {
    let command = Command.Settings.GetSettings(indexName: name, requestOptions: requestOptions)
  ...
  /**
     ...
     - Returns: Async operation
     */
  @discardableResult public func setSettings(
    _ settings: Settings,
