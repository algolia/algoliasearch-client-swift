...
public struct AddedToCartObjectIDs: Codable, JSONEncodable, Hashable {
    ...
    public init(eventName: String, eventType: ConversionEvent, eventSubtype: AddToCartEvent, index: String, objectIDs: [String], userToken: String, authenticatedUserToken: String? = nil, currency: String? = nil, objectData: [ObjectData]? = nil, timestamp: Int64? = nil, value: Value? = nil) {
