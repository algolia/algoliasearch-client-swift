...
/// Since Personalization is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "AlgoliaSearchClient_Personalization"
    ...
    fatalError("unable to find bundle named AlgoliaSearchClient_Personalization")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class PersonalizationResources: NSObject {
