...
extension TransportContainer {
  @discardableResult func customRequest<T: Decodable>(
    callType: CallType,
    request: URLRequest,
    ...
    transport.customRequest(
      callType: callType, request: request, requestOptions: requestOptions, completion: completion)
  }
  ...
  @discardableResult func customRequest<T: Decodable>(
    ...
    try transport.customRequest(
      callType: callType, request: request, requestOptions: requestOptions)
  }
}

extension TransportContainer {
  @discardableResult func execute<T: Decodable>(
...
extension TransportContainer where Self: Credentials {
  func execute<Output: Decodable & IndexTask & IndexNameContainer>(
    _ command: some AlgoliaCommand,
