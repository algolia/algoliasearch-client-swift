...
extension PartialUpdate.Action {
  ...
  public static func set(_ json: JSON) -> Self {
    .init(json)
  }
}
...
extension PartialUpdate.Action {
  ...
  public static func increment(value: Int) -> Self {
    .init(operation: .increment, value: .init(value))
  }

  /// Increment a numeric attribute
  /// - Parameter value: Value to increment by
  public static func increment(value: Float) -> Self {
    .init(operation: .increment, value: .init(value))
  }

  /// Increment a numeric attribute
  /// - Parameter value: Value to increment by
  public static func increment(attribute _: Attribute, value: Double) -> Self {
    .init(operation: .increment, value: .init(value))
  }
}
...
extension PartialUpdate.Action {
  /**
     ...
     */
  public static func incrementFrom(value: Int) -> Self {
  ...
  /**
     ...
     */
  public static func incrementSet(value: Int) -> Self {
...
extension PartialUpdate.Action {
  ...
  public static func decrement(value: Int) -> Self {
    .init(operation: .decrement, value: .init(value))
  }

  /// Decrement a numeric attribute
  /// - Parameter value: Value to decrement by
  public static func decrement(value: Float) -> Self {
    .init(operation: .decrement, value: .init(value))
  }

  /// Decrement a numeric attribute
  /// - Parameter value: Value to decrement by
  public static func decrement(value: Double) -> Self {
    .init(operation: .decrement, value: .init(value))
  }
}
...
extension PartialUpdate.Action {
  ...
  public static func add(value: String, unique: Bool) -> Self {
  ...
  /// - Parameter value: Value to append
  /// - Parameter unique: If true, append an element only if it’s not already present
  public static func add(value: Int, unique: Bool) -> Self {
    .init(operation: unique ? .addUnique : .add, value: .init(value))
  }
  ...
  /// - Parameter value: Value to append
  /// - Parameter unique: If true, append an element only if it’s not already present
  public static func add(value: Float, unique: Bool) -> Self {
    .init(operation: unique ? .addUnique : .add, value: .init(value))
  }
  ...
  /// - Parameter value: Value to append
  /// - Parameter unique: If true, append an element only if it’s not already present
  public static func add(value: Double, unique: Bool) -> Self {
    .init(operation: unique ? .addUnique : .add, value: .init(value))
  }
}
...
extension PartialUpdate.Action {
  ...
  public static func remove(value: String) -> Self {
    .init(operation: .remove, value: .init(value))
  }

  /// Remove all matching number elements from an array attribute
  /// - Parameter value: Value to remove
  public static func remove(attribute _: Attribute, value: Int) -> Self {
    .init(operation: .remove, value: .init(value))
  }

  /// Remove all matching number elements from an array attribute
  /// - Parameter value: Value to remove
  public static func remove(value: Float) -> Self {
    .init(operation: .remove, value: .init(value))
  }

  /// Remove all matching number elements from an array attribute
  /// - Parameter value: Value to remove
  public static func remove(value: Double) -> Self {
    .init(operation: .remove, value: .init(value))
  }
}
