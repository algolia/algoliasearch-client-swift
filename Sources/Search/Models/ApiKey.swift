...
/// API key object.
@objcMembers public class ApiKey: NSObject, Codable, JSONEncodable {
  ...
  public init(
    acl: [Acl], _description: String? = "", indexes: [String]? = nil, maxHitsPerQuery: Int? = 0,
    maxQueriesPerIPPerHour: Int? = 0, queryParameters: String? = "", referers: [String]? = nil,
    validity: Int? = 0
  ) {
    self.acl = acl
