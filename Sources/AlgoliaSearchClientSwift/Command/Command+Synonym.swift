...
extension Command {
  ...
  enum Synonym {
    ...
    struct Save: AlgoliaCommand {
      ...
      init(indexName: IndexName, synonym: AlgoliaSearchClientSwift.Synonym, forwardToReplicas: Bool?, requestOptions: RequestOptions?) {
    ...
    struct SaveList: AlgoliaCommand {
      ...
      init(indexName: IndexName, synonyms: [AlgoliaSearchClientSwift.Synonym], forwardToReplicas: Bool?, clearExistingSynonyms: Bool?, requestOptions: RequestOptions?) {
