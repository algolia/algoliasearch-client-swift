...
extension Command {
  enum Rule {
    struct Save: AlgoliaCommand {
      ...
      init(
        indexName: IndexName, rule: AlgoliaSearchClient.Rule, forwardToReplicas: Bool?,
    ...
    struct SaveList: AlgoliaCommand {
      ...
      init(
        indexName: IndexName, rules: [AlgoliaSearchClient.Rule], forwardToReplicas: Bool?,
        clearExistingRules: Bool?, requestOptions: RequestOptions?
      ) {
