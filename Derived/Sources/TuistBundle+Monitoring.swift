...
/// Since Monitoring is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "AlgoliaSearchClient_Monitoring"
    ...
    fatalError("unable to find bundle named AlgoliaSearchClient_Monitoring")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class MonitoringResources: NSObject {
