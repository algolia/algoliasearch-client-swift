...
public struct ConvertedObjectIDsAfterSearch: Codable, JSONEncodable, Hashable {
    ...
    public init(eventName: String, eventType: ConversionEvent, index: String, objectIDs: [String], queryID: String, userToken: String, authenticatedUserToken: String? = nil, timestamp: Int64? = nil) {
