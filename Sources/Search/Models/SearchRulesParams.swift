...
public struct SearchRulesParams: Codable, JSONEncodable, Hashable {
    ...
    public init(query: String? = nil, anchoring: Anchoring? = nil, context: String? = nil, page: Int? = nil, hitsPerPage: Int? = nil, enabled: Bool? = nil, requestOptions: [AnyCodable]? = nil) {
        self.query = query
