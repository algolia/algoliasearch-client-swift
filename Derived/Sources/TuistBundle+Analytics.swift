...
/// Since Analytics is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "AlgoliaSearchClient_Analytics"
    ...
    fatalError("unable to find bundle named AlgoliaSearchClient_Analytics")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class AnalyticsResources: NSObject {
