...
class TaggedStringTests: XCTestCase {
  ...
  func testMultipleHighlighted() {
    let input =
      "<em>Live</em> as <em>if you were</em> to die <em>tomorrow</em>. Learn as if you were to live <em>forever</em>"
  ...
  func testWholeStringHighlighted() {
    ...
    var taggedString = TaggedString(
      string: input, preTag: preTag, postTag: postTag, options: [.caseInsensitive])
  ...
  func testWithDecodedString() throws {
    ...
    let inlineString =
      "VIDÉO. Des CRS déployés devant un lycée <em>rennais</em> pour les épreuves anticipées du bac"
  ...
  func testNested() throws {
    let input =
      "Your time is limited, <em>so don't waste it living <em>someone else's life</em>. Don't be trapped by dogma – </em>which is living with the results of other people's thinking."
    var taggedString = TaggedString(string: input, preTag: preTag, postTag: postTag)
    ...
    XCTAssertEqual(
      taggedString.taggedSubstrings(),
      ["so don't waste it living someone else's life. Don't be trapped by dogma – "])
    XCTAssertEqual(
      taggedString.untaggedSubstrings(),
      ["Your time is limited, ", "which is living with the results of other people's thinking."])
  }

  func testNestedFollowing() throws {
    let input =
      "Your time is limited, <em><em>so don't waste it living someone else's life</em></em>. Don't be trapped by dogma – which is living with the results of other people's thinking."
    var taggedString = TaggedString(string: input, preTag: preTag, postTag: postTag)
    ...
    XCTAssertEqual(
      taggedString.taggedSubstrings(), ["so don't waste it living someone else's life"])
    XCTAssertEqual(
      taggedString.untaggedSubstrings(),
      [
  ...
  func testExtraOpenTag() throws {
    let input =
      "Your time is limited, <em>so don't waste it living <em>someone else's life. Don't be trapped by dogma – </em>which is living with the results of other people's thinking."
    var taggedString = TaggedString(string: input, preTag: preTag, postTag: postTag)
    ...
    XCTAssertEqual(
      taggedString.taggedSubstrings(), ["someone else's life. Don't be trapped by dogma – "])
    XCTAssertEqual(
      taggedString.untaggedSubstrings(),
      [
  ...
  func testExtraClosingTag() throws {
    let input =
      "Your time is limited, <em>so don't waste it living someone else's life.</em> Don't be trapped by dogma – </em>which is living with the results of other people's thinking."
    var taggedString = TaggedString(string: input, preTag: preTag, postTag: postTag)
  ...
  func testJustOpenTag() throws {
    let input =
      "Your time is limited, <em>so don't waste it living someone else's life. Don't be trapped by dogma – which is living with the results of other people's thinking."
    var taggedString = TaggedString(string: input, preTag: preTag, postTag: postTag)
  ...
  func testJustClosingTag() throws {
    let input =
      "Your time is limited, so don't waste it living someone else's life. Don't be trapped by dogma – </em>which is living with the results of other people's thinking."
    var taggedString = TaggedString(string: input, preTag: preTag, postTag: postTag)
