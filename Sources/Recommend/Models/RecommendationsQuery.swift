...
public struct RecommendationsQuery: Codable, JSONEncodable, Hashable {
    ...
    public init(indexName: String, threshold: Int? = nil, maxRecommendations: Int? = nil, model: RecommendationModels, objectID: String, queryParameters: SearchParamsObject? = nil, fallbackParameters: SearchParamsObject? = nil) {
