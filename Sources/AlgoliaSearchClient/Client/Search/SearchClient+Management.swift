...
extension SearchClient {
  ...
  /**
     ...
     */
  @discardableResult public func copyIndex(
    ...
    index(withName: source).copy(
      scope, to: destination, requestOptions: requestOptions, completion: completion)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func moveIndex(
    from source: IndexName,
    to destination: IndexName,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<IndexRevision>
  ) -> Operation & TransportTask {
    index(withName: source).move(
      to: destination, requestOptions: requestOptions, completion: completion)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func copyRules(
    from source: IndexName,
    to destination: IndexName,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<IndexRevision>
    ...
    index(withName: source).copy(
      .rules, to: destination, requestOptions: requestOptions, completion: completion)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func copySynonyms(
    from source: IndexName,
    to destination: IndexName,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<IndexRevision>
    ...
    index(withName: source).copy(
      .synonyms, to: destination, requestOptions: requestOptions, completion: completion)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func copySettings(
    from source: IndexName,
    to destination: IndexName,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<IndexRevision>
    ...
    index(withName: source).copy(
      .settings, to: destination, requestOptions: requestOptions, completion: completion)
  }
