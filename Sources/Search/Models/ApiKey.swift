...
public struct ApiKey: Codable, JSONEncodable, Hashable {
  ...
  public init(
    acl: [Acl], description: String? = nil, indexes: [String]? = nil, maxHitsPerQuery: Int? = nil,
    maxQueriesPerIPPerHour: Int? = nil, queryParameters: String? = nil, referers: [String]? = nil,
    validity: Int? = nil
  ) {
    self.acl = acl
