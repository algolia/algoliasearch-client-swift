...
public enum ExactOnSingleWordQuery: String, Codable {
  /**
  ...
  /**
   The exact ranking criterion is set to 1 if the query word is found in the record. The query word must be at least 3 characters long and must not be a stop word in any supported language.
   */
  case word
}
