...
@objcMembers public class Log: NSObject, Codable, JSONEncodable {
  ...
  public init(
    timestamp: String, method: String, answerCode: String, queryBody: String, answer: String,
    url: String, ip: String, queryHeaders: String, sha1: String, nbApiCalls: String,
    processingTimeMs: String, index: String? = nil, queryParams: String? = nil,
    queryNbHits: String? = nil, innerQueries: [LogQuery]? = nil
  ) {
