...
struct TestValues {
  ...
  let batchOperations: [BatchOperation] = [
    .init(action: .addObject, body: ["attr": "value"]),
    .init(action: .deleteObject, body: ["attr": "value"]),
  ]
  ...
  let requestOptions = RequestOptions(
    ...
    urlParameters: ["testParameter": "testParameterValue"])
  ...
  var personalizationStrategy: PersonalizationStrategy = {
    PersonalizationStrategy(
      eventsScoring: [.init(eventName: "e1", eventType: .view, score: 10)],
      facetsScoring: [.init(facetName: "a1", score: 20)], personalizationImpact: 100)
  }()
}
