//
// InfrastructureResponseMetrics.swift
//
...
public struct InfrastructureResponseMetrics: Codable, JSONEncodable, Hashable {
  ...
  public init(
    cpuUsage: [String: [ProbesMetric]]? = nil, ramIndexingUsage: [String: [ProbesMetric]]? = nil,
    ramSearchUsage: [String: [ProbesMetric]]? = nil, ssdUsage: [String: [ProbesMetric]]? = nil,
