...
extension AnalyticsClient {
  ...
  /**
     ...
     */
  @discardableResult public func addABTest(
    _ abTest: ABTest,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<ABTestCreation>
  ) -> Operation {
  ...
  @discardableResult public func addABTest(
    _ abTest: ABTest,
    requestOptions: RequestOptions? = nil
  ) throws -> WaitableWrapper<ABTestCreation> {
    let command = Command.ABTest.Add(abTest: abTest, requestOptions: requestOptions)
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func getABTest(
    withID abTestID: ABTestID,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<ABTestResponse>
  ) -> Operation {
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func stopABTest(
    withID abTestID: ABTestID,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<ABTestRevision>
  ) -> Operation {
  ...
  @discardableResult public func stopABTest(
    withID abTestID: ABTestID,
    requestOptions: RequestOptions? = nil
  ) throws -> WaitableWrapper<ABTestRevision> {
    let command = Command.ABTest.Stop(abTestID: abTestID, requestOptions: requestOptions)
    return try execute(command)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func deleteABTest(
    withID abTestID: ABTestID,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultTaskCallback<ABTestDeletion>
  ) -> Operation {
  ...
  @discardableResult public func deleteABTest(
    withID abTestID: ABTestID,
    requestOptions: RequestOptions? = nil
  ) throws -> WaitableWrapper<ABTestDeletion> {
    let command = Command.ABTest.Delete(abTestID: abTestID, requestOptions: requestOptions)
    return try execute(command)
  }
  ...
  /**
     ...
     - Returns: Launched asynchronous operation
     */
  @discardableResult public func listABTests(
    offset: Int?,
    limit: Int?,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<ABTestsResponse>
  ) -> Operation {
  ...
  public func browseAllABTests(
    ...
    let operation = BlockOperation {
      completion(
        .init {
          try self.browseAllABTests(hitsPerPage: hitsPerPage, requestOptions: requestOptions)
        })
    }
  ...
  public func browseAllABTests(
    ...
    var page = 0
    while true {
      let response = try listABTests(
        offset: page, limit: hitsPerPage, requestOptions: requestOptions)
