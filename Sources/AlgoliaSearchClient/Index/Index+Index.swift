...
extension Index {
  ...
  @discardableResult public func delete(
    ...
    completion: @escaping ResultTaskCallback<IndexDeletion>
  ...
  /**
     ...
     - Returns: Bool
     */
  @discardableResult public func exists() throws -> Bool {
    let command = Command.Settings.GetSettings(indexName: name, requestOptions: nil)
  ...
  @discardableResult public func copy(
    ...
    let command = Command.Index.Operation(
      indexName: name,
      operation: .init(action: .copy, destination: destination, scopes: scope.components),
  ...
  @discardableResult public func move(
    ...
    let command = Command.Index.Operation(
      indexName: name, operation: .init(action: .move, destination: destination, scopes: nil),
      requestOptions: requestOptions)
    return execute(command, completion: completion)
  }
