...
extension Index {
  ...
  /**
     ...
     */
  @discardableResult public func taskStatus(
    for taskID: TaskID,
    requestOptions: RequestOptions? = nil,
    completion: @escaping ResultCallback<TaskInfo>
  ) -> Operation & TransportTask {
    let command = Command.Advanced.TaskStatus(
      indexName: name, taskID: taskID, requestOptions: requestOptions)
  ...
  /**
       ...
       - parameter requestOptions: Configure request locally with RequestOptions
     */
  @discardableResult public func waitTask(
    withID taskID: TaskID,
