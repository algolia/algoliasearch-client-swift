...
public struct RuleResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(metadata: RuleResponseMetadata? = nil, objectID: String, conditions: [Condition]? = nil, consequence: Consequence? = nil, description: String? = nil, enabled: Bool? = nil) {
