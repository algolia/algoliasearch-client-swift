...
public struct SynonymHit: Codable, JSONEncodable, Hashable {
    ...
    public init(objectID: String, type: SynonymType, synonyms: [String]? = nil, input: String? = nil, word: String? = nil, corrections: [String]? = nil, placeholder: String? = nil, replacements: [String]? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(replacements, forKey: .replacements)
    }
}
