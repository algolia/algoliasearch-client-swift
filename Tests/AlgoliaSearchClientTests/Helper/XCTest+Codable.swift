...
func AssertEncodeDecode(
  _ value: some Codable, _ rawValue: JSON, file: StaticString = #file, line: UInt = #line
) throws {
  try AssertEncode(value, expected: rawValue, file: file, line: line)
  try AssertDecode(rawValue, expected: value, file: file, line: line)
}

func AssertMatch(_ data: Data, _ expected: JSON, file _: StaticString = #file, line _: UInt = #line)
{
...
func AssertDecode<T: Codable & Equatable>(
  _ input: JSON, expected: T, file: StaticString = #file, line: UInt = #line
) throws {
...
@discardableResult func AssertDecode<T: Decodable>(
  jsonFilename filename: String, expected _: T.Type, file _: StaticString = #file,
  line _: UInt = #line
) throws -> T {
...
func AssertEncode(
  _ value: some Encodable, expected: JSON, file: StaticString = #file, line: UInt = #line
) throws {
  let encoder = JSONEncoder()
  encoder.dateEncodingStrategy = .swiftAPIClient
...
func AssertEquallyEncoded(
  _ l: some Encodable, _ r: some Encodable, file _: StaticString = #file, line _: UInt = #line
) throws {
  let encoder = JSONEncoder()
  encoder.dateEncodingStrategy = .swiftAPIClient
