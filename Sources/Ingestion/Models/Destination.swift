...
public struct Destination: Codable, JSONEncodable, Hashable {
    ...
    public init(destinationID: String, type: DestinationType, name: String, input: DestinationInput, createdAt: String, updatedAt: String? = nil, authenticationID: String? = nil) {
