...
public struct RecommendBaseSearchParams: Codable, JSONEncodable {
    /// Search query.
...
extension RecommendBaseSearchParams: Equatable {
...
extension RecommendBaseSearchParams: Hashable {
